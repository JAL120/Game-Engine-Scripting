...
public class Player : MonoBehaviour
{
    ...
    void HandleHorizontalRotation()
    {
        ...
        if (mouseDeltaX != 0)
        {
            ...
            float rotationAmount = rotation * Time.deltaTime * mouseDeltaX;

            transform.Rotate(Vector3.up, rotation * Time.deltaTime * rotDir);
            //Camera.main.transform.RotateAround(transform.position, Vector3.up, rotation * Time.deltaTime * rotDir);
        }
    }
